...
type NestingClient interface {
	...
	Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*VirtualMachine, error)
...
func (c *nestingClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*VirtualMachine, error) {
...
type NestingServer interface {
	...
	Create(context.Context, *CreateRequest) (*VirtualMachine, error)
...
func (UnimplementedNestingServer) Create(context.Context, *CreateRequest) (*VirtualMachine, error) {
